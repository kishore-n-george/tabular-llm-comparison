"""
Improved FT-Transformer Training for Airbnb Regression

This script implements an improved FT-Transformer for Airbnb price prediction with:
...
def load_enhanced_data(enhanced_data_path='./Section1_Data_PreProcessing/enhanced_data.pkl'):
    ...
    print("🏠 Loading enhanced Airbnb data from XGBoost preprocessing...")
    ...
    try:
        ...
        print(f"Task: Regression (Airbnb Price Prediction)")
        ...
        return load_basic_preprocessed_data()

def load_basic_preprocessed_data(data_path='./Section1_Data_PreProcessing/airbnb_preprocessed_data.pkl'):
    """Fallback function to load basic preprocessed data"""
    print("🏠 Loading basic preprocessed Airbnb data...")
    ...
    try:
        ...
        # Create dummy transform_info for compatibility
        ...
        print("❌ Basic preprocessed data not found!")
...
def run_improved_ft_transformer_training(enhanced_data_path='./Section1_Data_PreProcessing/enhanced_data.pkl',
                                        device=None, batch_size=128, learning_rate=5e-4,
                                        weight_decay=1e-4, save_dir='./Section2_Model_Training'):
    """Run complete improved FT-Transformer training pipeline with enhanced data"""
    print("🏠 Starting Improved FT-Transformer Training Pipeline with Enhanced Data")
    print("="*60)
...
if __name__ == "__main__":
    ...
    print("🚀 Running Improved FT-Transformer Training for Airbnb")
